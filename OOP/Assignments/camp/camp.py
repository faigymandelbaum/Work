...
class Camp:
    ...
    def add_counselor(self, first_name, last_name, salary): # Hire date is the cuurent date of the time that was assigned.
        counselor = self.find_counselor(first_name, last_name)
        if counselor == None:
            new_counselor = Counselor(first_name, last_name, salary)
    ...
    def add_bunk(self, bunk_name, counselor_fname, counselor_lname):
        ...
        if bunk_counselor == None:
            print ("Counselor {} {} not found. Could not add bunk.".format(counselor_fname, counselor_lname))
            ...
            if self.num_bunks < self.max_bunks:
                ...
                print ('You have reached the max nummer of bunks. Cannot add bunks anymore.')
    ...
    def place_camper(self, first_name, last_name, bunk_name):
        ...
        if campers_bunk == None:
            print ("Bunk {} not found.".format(bunk_name))
        elif camper == None:
